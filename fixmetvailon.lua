...
local Window = Fluent:CreateWindow({
    Title = "Banana Hub",
    SubTitle = "BananaHub [ Free Version ] by Obii",
    TabWidth = 160,
...
local Tabs = {
    ...
    Raid = Window:AddTab({ Title = "Dungeon", Icon = "swordsrepeat wait() until game.Players
...
ImageButton.Image = "rbxassetid://18587394505"
